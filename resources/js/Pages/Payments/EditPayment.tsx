...
export default function EditPayment({
    ...
    return (
        <div className="w-full md:w-96 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-lg overflow-hidden">
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            setFormData({
                                ...formData,
                                plan_type: e.target.value as "monthly" | "yearly",
                            })
                        }
            ...
            {/* Action Buttons */}
            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
                <button
                    type="button"
                    onClick={onCancel}
